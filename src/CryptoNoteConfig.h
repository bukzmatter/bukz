// Copyright (c) 2012-2016, The CryptoNote developers, The Bytecoin developers, The Balkancoin developers
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1c624f; // addresses start with "K"
